        ...
        <div id="rectangle">
            <form action="profile.php" method="POST" style="border:1px solid #ccc">
                <div class="container">
                    ...
                    <p style="text-align: center;">Please enter your new email address</p>
                    <hr>

                    <label for="email"><b>New Email</b></label>
                    <input type="email" placeholder="Your new email" name="new_email" id="email" required>

                    <div class="clearfix">
                        <button type="submit" class="resetpassbtn">Update Email</button>
                    </div>
                </div>
            </form>
        </div>
